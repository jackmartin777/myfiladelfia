...
const ContactUs: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Get in Touch - MyFiladelfia</title>
        <meta name="description" content="Contact MyFiladelfia for inquiries about our biblical counselling and theology courses." />
      </Helmet>
      <section id="contact" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center text-primary-dark">Get in Touch</h1>
          ...
          <div className="mt-12 text-center">
            <h2 className="text-2xl font-semibold mb-6 text-primary-dark">Connect With Us</h2>
          ...
          <div className="mt-12 text-center">
            <h2 className="text-2xl font-semibold mb-6 text-primary-dark">Share This Page</h2>
            <div className="flex justify-center space-x-4">
